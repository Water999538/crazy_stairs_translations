...
module.gui.switcher = {
	...
	["fail"] = "ERREUR DE RAFRAÎCHISSEMENT!",

	--NEW
	["refreshbutton"] = "RAFRAÎCHIR",
	["failed"] = "Téléportation a échoué!",
	["classic"] = "Tour Classique",
	["pro"] = "Tour Pro",
	["custom"] = "Tour Personnalisée",
	["noVR"] = "Tour Sans VR",
	--END NEW
...
module.gui.serversettings = {
	...
	["Drones"] = "RÉGLAGES DES DRONES",
	["DronesReadOnly"] = "RÉGLAGES DES DRONES (lecture seule)",
	["DroneEnabled"] = "Drones activé",
	["DroneFix"] = "les Drones restaurent les escaliers",
	["DroneRemove"] = "les Drones enlèvent les intersections maudites",
	["DroneUnCurse"] = "les Drones restaurent les escaliers maudits",
	["DroneMove"] = "les Drones bougent les escaliers en mode par défaut",
	["DroneSpin"] = "les Drones tournent les escaliers en mode par défaut",
	["DroneSpeed"] = "Vitesse des drones (niveaux/secondes)",
	["DroneDelay"] = "Durée de rotation des Drones (secondes)",
	["DroneMax"] = "Nombre d'escaliers max (les drones vont exclusivement détruire au dessus de cette limite)",
	["DroneMin"] = "Nombre d'esaliers min (les drones vont exclusivement créer en dessous de cette limite)",
	["DroneBlock"] = "Chance d’intersections maudites pour chaque intersections vides reencontrés (pourcentage)",
	["DroneCurse"] = "Chance d'escaliers maudits pour création et escaliers normaux rencontrés (pourcentage)",

	["Tower"] = "RÉGLAGES DE LA TOUR",
	["TowerReadOnly"] = "RÉGLAGES DE LA TOUR (lecture seule)",
	["InfMode"] = "Mode Infini (ne peut pas être changé durant une course ou une régénération)",
...
module.spells.names = {
	...
	["split"] = "Reconstruire à l'Opposé",
	["shrinkabove"] = "Rétrécir l'Escalier Au Dessus",
	["link"] = "Créer un Pont",
	["portal"] = "Créer un Portail",

	["summoner"] = "Invocateur",
	["patronevent"] = "Surchage d'Escaliers",
	["patronaltevent"] = "Rétrécissement",

	--JOKER 
	["flip"] = "Retourner l'Escalier",
	["flipabove"] = "Retourner l'Escalier Au Dessus",
